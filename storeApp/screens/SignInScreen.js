...
import { View, Text, Button, StyleSheet, Dimensions, Image, Platform, TouchableOpacity } from 'react-native';
    ...
    return (
        <View style={styles.container}>
            <Animatable.View
                style={styles.header}
                animation="fadeIn">
                <Text style={styles.text_header}>Track Me for Buisness</Text>
            </Animatable.View>
            <Animatable.View
                style={styles.footer}
                ...
                <FormInput
                    ...
                    placeholderText="사업자용 이메일을 입력하세요."
